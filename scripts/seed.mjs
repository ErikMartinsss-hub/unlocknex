...
const remoteOverrides = {
  'remote-3': { provider: 'auto', productUuid: '2216', apiField: 'Quantity' },
  'remote-4': { provider: 'auto', productUuid: '2216', apiField: 'Quantity' },
  'remote-5': { provider: 'auto', productUuid: '2211', apiField: 'Quantity' },
  'remote-6': { provider: 'auto', productUuid: '2189', apiField: 'Quantity', apiExtra: [{ key: 'UltraViewer ID', label: 'UltraViewer ID', required: true }, { key: 'UltraViewer Password', label: 'UltraViewer Password', required: true }] },
  'remote-7': { provider: 'auto', productUuid: '2998', apiField: 'Quantity' },
  'remote-8': { provider: 'auto', productUuid: '2333', apiField: 'Quantity' },
  'remote-9': { provider: 'auto', productUuid: '2194', apiField: 'Quantity' },
  'remote-12': { provider: 'auto', productUuid: '2215', apiField: 'Quantity', apiExtra: [{ key: 'UltraViewer ID', label: 'UltraViewer ID', required: true }, { key: 'UltraViewer Password', label: 'UltraViewer Password', required: true }] },
  'remote-13': { provider: 'auto', productUuid: '2214', apiField: 'Quantity' },
  'remote-14': { provider: 'auto', productUuid: '2209', apiField: 'Quantity' },
  'remote-25': { provider: 'auto', productUuid: '2182', apiField: 'Quantity' },
  'remote-26': { provider: 'auto', productUuid: '2212', apiField: 'Quantity' },
  'remote-30': { provider: 'auto', productUuid: '2211', apiField: 'Quantity' },
  'remote-37': { provider: 'auto', productUuid: '2210', apiField: 'Quantity' },
  'remote-39': { provider: 'auto', productUuid: '2203', apiField: 'Quantity' },
  'remote-40': { provider: 'auto', productUuid: '2202', apiField: 'Quantity' },
  'remote-41': { provider: 'auto', productUuid: '2205', apiField: 'Quantity' },
  'remote-45': { provider: 'auto', productUuid: '2187', apiField: 'Quantity', apiExtra: [{ key: 'UltraViewer ID', label: 'UltraViewer ID', required: true }] },
  'remote-52': { provider: 'auto', productUuid: '2185', apiField: 'Quantity', apiExtra: [{ key: 'UltraViewer ID', label: 'UltraViewer ID', required: true }] },
  'remote-53': { provider: 'auto', productUuid: '2185', apiField: 'Quantity', apiExtra: [{ key: 'UltraViewer ID', label: 'UltraViewer ID', required: true }] },
  'remote-54': { provider: 'auto', productUuid: '2200', apiField: 'Quantity' },
  'remote-55': { provider: 'auto', productUuid: '2196', apiField: 'Quantity' },
  'remote-58': { provider: 'auto', productUuid: '2183', apiField: 'Quantity', apiExtra: [{ key: 'UltraViewer ID', label: 'UltraViewer ID', required: true }, { key: 'UltraViewer Password', label: 'UltraViewer Password', required: true }] },
};

const remoteServices = remoteBase.map(([id, name, price, deliveryTime]) => ({
  id,
  slug: `aluguel-${id.split('-')[1]}`,
  categoryId: 'cat-remote',
  name,
  description:
    remoteOverrides[id]?.provider === 'auto'
...
remoteServices.forEach((s) => batch.set(db.doc(`services/${s.id}`), { ...s, isActive: true }));
await batch.commit();

console.log(`Seed OK: ${categories.length} categorias e ${services.length + remoteServices.length} serviços no Firestore.`);
